...
public class VerifyEmailSoapService implements WebService {
    ...
    /**
     * WeatherSOAPService - Constructor Adds itself to the ATFHandler Services
     * collection
     */
    ...
    public String verifyEmail(String emailToVerify, String licenseKey) {
        try {
            ...
            SOAPMessage soapResponse = (SOAPMessage) ATFHandler.getInstance().getWebServiceAutomation().sendSoapMessage(VERIFYEMAIL_SERVICE_KEY,
                    request);
