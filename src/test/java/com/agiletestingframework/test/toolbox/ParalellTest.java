...
/*
 * Uncomment to validate parallel Testing public class ParalellTest {
 * 
 * 
 * @BeforeMethod(alwaysRun = true) public void BeforeMethodSetup() {
 * System.out.println("BM Thread id = " + Thread.currentThread().getId());
 * System.out.println("BM Hashcode of webDriver instance = " +
 * ATFHandler.getInstance().getWebAutomation().getWebDriver().hashCode()); }
 * 
 * @AfterMethod(alwaysRun=true) public void afterTeardown() {
 ...
 * 
 * @Test public void testMethod1() { invokeBrowser("http://www.cnn.com");
 * 
 * }
 * 
 * @Test public void testMethod2() { invokeBrowser("https://www.facebook.com");
 * 
 * }
 * 
 ...
 * 
 * 
 * private void invokeBrowser(String url) { System.out.println("Thread id = " +
 * Thread.currentThread().getId());
 * System.out.println("Hashcode of webDriver instance = " +
 * WebDriverManager.getDriver().hashCode());
