...
public class ScreenImageAutomationManager {
    ...
    public ScreenRegion getFullScreen() { return fullScreen; }
    ...
    /**
     * saveBufferedImage
     * Buffered image will be saved to the configured buffered image save location + fileName
     * @param fileName file name to save image as
     * @param imageToSave BufferedImage to save to file
     */
	...
	/**
	 * isImageDisplayed
	 * @param screenRegionToSearch the screen region to attempt to locate the image pattern
	 * @param imagePattern image pattern to match and wait (Will look in resources)
	 ...
	 * isImageDisplayed
	 * @param screenRegionToSearch the screen region to attempt to locate the image pattern
	 * @param imagePattern image pattern to match (Will look in resources)
	 * @param implicitWait wait time for image to match in milliseconds
	 * @return TRUE if image if found, FALSE if image is not found within the time allocated
	 */
	...
	/**
	 * isImageDisplayed
	 * @param screenRegionToSearch screenRegionToSearch the screen region to attempt to locate the image pattern
	 * @param imagePatternFile image pattern file to use to match
	 * @return TRUE if image if found, FALSE if image is not found within the time allocated
	 */
