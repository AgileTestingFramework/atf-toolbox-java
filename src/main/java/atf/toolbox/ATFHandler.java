...
public class ATFHandler {
	...
	/**
	 * getWebAutomation
	 * Used to perform web automation tasks
	 */
	 ...
	 * Used to perform database automation tasks
	 */
	...
	/**
	 * getWebServiceAutomation
	 * Used to perform web service automation tasks
	 */
	...
	/**
	 * getMobileAutomation
	 * Used to perform mobile automation tasks
	 */
    ...
    public void teardown()
    {
    	if (webAutomationInstance != null)
    	{
            if (webAutomationInstance != null)
            {
                ...
                if (webAutomationInstance.getWebDriver() instanceof FirefoxDriver && ConfigurationManager.getInstance().getWebUseJSErrorCollectorWithFirefox())
                {
